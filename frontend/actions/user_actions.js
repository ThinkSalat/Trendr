...
export const fetchNextPostsFromUser = (userId, offset, date) => dispatch => UserAPIUtil.fetchUser(userId, offset, date).then(data => dispatch(receiveNextPostsFromUser(data)));
